...
function writeTaoDocument(pages)
{
    ...
    var ddd = '// Document generated by the Tao Editor from file\n' +
              '// '+ path.basename(jsonFilePath('pages', true)) +
              ' on ' + (new Date()).toISOString() + '.\n//\n' +
              '// DO NOT EDIT this file manually, or your changes would be\n' +
              '// overwritten the next time you use the Tao Editor.\n\n'
    var ctx = {};
    for (var i = 0; i < pages.length; i++)
    {
        var page = pages[i];
